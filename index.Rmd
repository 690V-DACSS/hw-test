...
```{r}
## for del1Draft.rds
link1="https://github.com/690V-DACSS/hw-test/raw/main/del1Draft.rds"
readRDS(url(link1))
```
...
```{r}
## for del2Draft.rds
link2="https://github.com/690V-DACSS/hw-test/raw/main/del2Draft.rds"
readRDS(url(link2))
```
...
```{r}
## for del3Draft.rds
link3="https://github.com/690V-DACSS/hw-test/raw/main/del3Draft.rds"
readRDS(url(link3))
```
